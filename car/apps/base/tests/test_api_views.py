...
from car.apps.base.api.serializers import CitySerializer
from car.apps.base.api.views import CityAPIView, TypeDocumentAPIView
from car.apps.base.tests.base_helpers import BaseAPITestCase
from car.apps.base.tests.factories import CityFactory
