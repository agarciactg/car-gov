...
from car.apps.base import managers
...
class EnvironmentalAuthorities(BaseModel):
    name = models.CharField("Nombre Autoridad", max_length=340)
...
class Government(BaseModel):
    name = models.CharField("Nombre de Gobernación", max_length=340)
...
class City(BaseModel):
    ...
    government = models.ManyToManyField(
        Government,
        related_name="city_government",
        verbose_name="Gobernación",
        blank=True,
    )
