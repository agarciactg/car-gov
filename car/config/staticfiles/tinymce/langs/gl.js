tinymce.addI18n("gl", {
  ...
  "To open the popup, press Shift+Enter":
    "Para abrir a xanela emerxente, prema Mai\u00fas+Intro",
  "Rich Text Area. Press ALT-0 for help.":
    "\u00c1rea de texto mellorado. PremaALT-0 para obter axuda.",
  "System Font": "Tipo de letra do sistema",
  "Failed to upload image: {0}": "Produciuse un fallo ao cargar a imaxe: {0}",
  "Failed to load plugin: {0} from url {1}":
    "Produciuse un fallo ao cargar a o engadido: {0} dende o URL {1}",
  "Failed to load plugin url: {0}":
    "Produciuse un fallo ao cargar a o URL do engadido: {0}",
  "Failed to initialize plugin: {0}":
    "Produciuse un fallo ao iniciar o engadido: {0}",
  example: "exemplo",
  Search: "Buscar",
  All: "Todo",
  Currency: "Moeda",
  ...
  "yuan character, in hong kong and taiwan":
    "Car\u00e1cter do yuan, en Hong Kong e Taiwan",
  ...
  "Error: Form submit field collision.":
    "Erro: conflito de campo ao enviar o formulario ",
  "Error: No form element found.":
    "Erro: non se atopou ning\u00fan elemento de formulario",
  Update: "Actualizar",
  ...
  "Switch to or from fullscreen mode":
    "Activar ou desactivar o modo de pantalla completa",
