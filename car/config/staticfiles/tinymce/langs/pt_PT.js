tinymce.addI18n("pt_PT", {
  ...
  "To open the popup, press Shift+Enter":
    "Para abrir a janela flutuante, pressione Shift+Enter",
  "Rich Text Area. Press ALT-0 for help.":
    "\u00c1rea de texto formatado. Pressione ALT-0 para exibir a ajuda.",
  "System Font": "Tipo de letra do sistema",
  "Failed to upload image: {0}": "Falha ao carregar imagem: {0}",
  "Failed to load plugin: {0} from url {1}":
    "Falha ao carregar plugin: {0} do URL {1}",
  ...
  "yuan character, in hong kong and taiwan":
    "Iuane, em Hong Kong e Rep\u00fablica da China - s\u00edmbolo de moeda",
  "yen/yuan character variant one":
    "Iene/Iuane - variante do s\u00edmbolo de moeda",
  "Loading emoticons...": "A carregar \u00edcones expressivos...",
  "Could not load emoticons":
    "N\u00e3o foi poss\u00edvel carregar \u00edcones expressivos",
  People: "Pessoas",
  ...
  "Error: Form submit field collision.":
    "Erro: conflito no campo de submeter formul\u00e1rio.",
  "Error: No form element found.":
    "Erro: nenhum elemento de formul\u00e1rio encontrado.",
  Update: "Atualizar",
  ...
  "Switch to or from fullscreen mode":
    "Entrar ou sair do modo de ecr\u00e3 inteiro",
