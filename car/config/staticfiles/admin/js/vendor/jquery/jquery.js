...
(function (global, factory) {
  ...
  function adoptValue(value, resolve, reject, carlue) {
    var method;
    ...
    try {
      ...
      if (value && isFunction((method = value.promise))) {
        ...
        // Control `resolve` arguments by letting Array#slice cast boolean `carlue` to integer:
        // * false: [ value ].slice( 0 ) => resolve( value )
        // * true: [ value ].slice( 1 ) => resolve()
        resolve.apply(undefined, [value].slice(carlue));
      }
