...
APPS_DIR = os.path.join(ROOT_DIR, "car")
...
WSGI_APPLICATION = "car.config.wsgi.application"
ASGI_APPLICATION = "car.config.asgi.application"
...
REST_FRAMEWORK = {
    "DEFAULT_RENDERER_CLASSES": [
        "car.utils.renderers.carRenderer",
    ...
    "EXCEPTION_HANDLER": "car.utils.handlers.car_api_exception_handler",
    "DEFAULT_PAGINATION_CLASS": "car.apps.base.utils.StandardResultsPagination",
}
