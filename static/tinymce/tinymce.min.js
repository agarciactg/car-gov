...
!(function () {
  ...
  var Ne,
    ...
    hn = function (e) {
      ...
      return r === n
        ? pn(r.offsetLeft, r.offsetTop)
        : dn(e)
        ? ((t = n.getBoundingClientRect()), pn(t.left, t.top))
        : pn(0, 0);
    },
    vn = function (e) {
    ...
    bn = function (e, t) {
      st().browser.isSafari() && A(e.dom.scrollIntoViewIfNeeded)
    ...
    nr = function (e, t, n) {
      ...
      if (((n = n || e), t)) {
        if (
          ...
          "static" === Yn(Nt.fromDom(e), "position")
        )
          return {
            x: (a =
        ...
        for (r = t; r && r !== n && r.nodeType && !tr(r, n); )
          (a += r.offsetLeft || 0),
            (u += r.offsetTop || 0),
            (r = r.offsetParent);
        for (r = t.parentNode; r && r !== n && r.nodeType && !tr(r, n); )
  ...
  (_e = undefined),
    ...
    (function (e) {
      ...
      return (function l(i, a, u) {
        ...
        for (var c = "function" == typeof Ae && Ae, e = 0; e < u.length; e++)
          s(u[e]);
        return s;
      })(
        {
  ...
  var yr,
    ...
    Er = function (e, t) {
      return (
        ...
        _t(o) ? U.none() : U.from(o.querySelector(n)).map(Nt.fromDom)
      );
      var n, r, o;
    },
    kr = function (e, t, n) {
      ...
      : ((yr =
        ...
        (br.all = function () {
          var s = Array.prototype.slice.call(
            1 === arguments.length && yr(arguments[0])
              ? arguments[0]
              : arguments
          );
    ...
    try {
      ...
      if (e && ("object" == typeof e || "function" == typeof e)) {
        ...
        if ("function" == typeof t)
          return void Pr(Rr(t, e), Rr(Ar, this), Rr(Dr, this));
      }
    ...
    var g = 0,
      ...
      t = function (e) {
        ...
        de(h, r).each(function (e) {
          var t, n;
          0 == --e.count &&
            (delete h[r], (t = e.id), (n = en(v)), Er(n, "#" + t).each(ln));
        });
      };
    return {
      load: n,
  ...
  var qr,
    ...
    lo = function (e) {
      return (
        co(e) && (e = e.parentNode), so(e) && e.hasAttribute("data-mce-caret")
      );
    },
    fo = function (e) {
    ...
    go = function (e) {
      ...
      return (
        !!On(t) &&
        (t.data.charAt(e.offset()) === io ||
          (e.isAtStart() && fo(t.previousSibling)))
      );
    },
    ho = function (e) {
      var t = e.container();
      return (
        !!On(t) &&
        (t.data.charAt(e.offset() - 1) === io ||
          (e.isAtEnd() && fo(t.nextSibling)))
      );
    },
    vo = function (e, t, n) {
      var r,
    ...
    To = function (e) {
      return (
        !Ro(e) && (No(e) ? !Eo(e.parentNode) : ko(e) || So(e) || _o(e) || Ao(e))
      );
    },
    Ao = function (e) {
      return (
        !1 === (Nn((t = e)) && "true" === t.getAttribute("unselectable")) &&
        xo(e)
      );
      var t;
    },
    ...
    Lo = function (e, t) {
      return (
        (To(e) &&
          !1 === ((o = t), On((r = e)) && Bo(r.data) && !1 === Po(r, o))) ||
        (Nn((n = e)) &&
          "A" === n.nodeName &&
          !n.hasAttribute("href") &&
      ...
      var u,
        ...
        c = function (e, t) {
          var n,
            ...
            i = (e = fi(e)).length;
          for (t = fi(t); i--; )
            for (n = s[e[i]], r = 0, o = t.length; r < o; r++)
              (n.attributes[t[r]] = {}), n.attributesOrder.push(t[r]);
        };
      return oi[e]
        ? oi[e]
        : ((u = "id accesskey class dir lang style tabindex title role"),
          ...
          a(
            "form",
            "accept-charset action autocomplete enctype method name carlidate target",
            r
          ),
          ...
          a(
            "input",
            "accept alt autocomplete checked dirname disabled form formaction formenctype formmethod formcarlidate formtarget height list max maxlength min multiple name pattern readonly required size src step type value width"
          ),
          a(
            "button",
            "disabled form formaction formenctype formmethod formcarlidate formtarget name type value",
            "html4" === e ? r : n
          ),
          a(
            "select",
  ...
  function pi(i) {
    var x = {},
      ...
      e = function (e, t, n) {
        ...
        return (
          r
            ? (r = ai(r, /[, ]/, ai(r.toUpperCase(), /[, ]/)))
            : (r = oi[e]) ||
              ((r = ai(t, " ", ai(t.toUpperCase(), " "))),
              (r = si(r, n)),
              (oi[e] = r)),
          r
        );
        ...
        e &&
          ...
          ui(fi(e, ","), function (e) {
            ...
            (u[i] = u[o]),
              ...
              x[i] ||
                ((t = x[o]),
                delete (t = si({}, t)).removeEmptyAttrs,
    ...
    i.valid_elements
      ...
      : (ui(n, function (e, t) {
        ...
        ui(
          fi("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
          function (e) {
            x[e].paddEmpty = !0;
          }
        ),
              ...
              if (
                ...
                "font-weight" === n && "700" === r
                  ...
                  : ("color" !== n && "background-color" !== n) ||
                    (r = r.toLowerCase()),
                  (r = (r = r.replace(C, gi)).replace(w, y)),
                  (c[n] = o ? g(r, !0) : r);
              }
            d("border", "", !0),
              d("border", "-width"),
    ...
    Si = function (e, t) {
      ...
      return (
        ...
        (s.preventDefault = function () {
          (s.isDefaultPrevented = Ci),
            e && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1));
        }),
        (s.stopPropagation = function () {
          (s.isPropagationStopped = Ci),
            e &&
        ...
        !(s.stopImmediatePropagation = function () {
          ...
          ((u = s).isDefaultPrevented === Ci || u.isDefaultPrevented === bi) &&
          ((s.isDefaultPrevented = bi),
          (s.isPropagationStopped = bi),
          (s.isImmediatePropagationStopped = bi)),
          ...
          if (((i = this.events[a]), e)) {
            for (var u, s, c, l, f = e.split(" "), d = f.length; d--; )
              if ((l = i[(o = f[d])])) {
                ...
                (t && 0 !== l.length) ||
                  (delete i[o],
                  xi(n, l.fakeName || o, l.nativeHandler, l.capture));
              }
          } else
            oe(i, function (e, t) {
  ...
  try {
    na.apply((Zi = ra.call(qi.childNodes)), qi.childNodes),
      Zi[qi.childNodes.length].nodeType;
  } catch (pk) {
    na = {
      apply: Zi.length
        ? function (e, t) {
  ...
  var Na = function (e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : qi) !== Mi && Ii(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
    ...
    if (Ui && !r) {
      if ((o = ba.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && ki.getElementsByClassName)
  ...
  function Ea() {
    ...
    function r(e, t) {
      return (
        n.push(e + " ") > _i.cacheLength && delete r[n.shift()],
        (r[e + " "] = t)
      );
    }
    return r;
    ...
    return (
      ...
      ka(function (e, t, n, r) {
        var o,
          ...
          d = g ? (v || (e ? m : c || h) ? [] : t) : f;
        if ((g && g(f, d, n, r), h))
          for (o = Pa(d, s), h(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
        if (e) {
          if (v || m) {
            if (v) {
  ...
  (ki = Na.support = {}),
        ...
        return s !== Mi && 9 === s.nodeType && s.documentElement
          ? ((Fi = (Mi = s).documentElement),
            ...
            (_i.find.TAG = ki.getElementsByTagName
              ? function (e, t) {
                  if (typeof t.getElementsByTagName != Ji)
                    ...
                    (1 &
                      (n =
                        (e.ownerDocument || e) === (t.ownerDocument || t)
                          ...
                          : 1) ||
                    (!ki.sortDetached && t.compareDocumentPosition(e) === n)
    ...
    (Na.attr = function (e, t) {
      ...
      var n = _i.attrHandle[t.toLowerCase()],
        r =
          n && Qi.call(_i.attrHandle, t.toLowerCase())
            ? n(e, t, !Ui)
            : undefined;
      return r !== undefined
        ? r
    ...
    (Na.uniqueSort = function (e) {
      var t,
        ...
        o = 0;
      if (
        ((Li = !ki.detectDuplicates),
        (Pi = !ki.sortStable && e.slice(0)),
        e.sort(Gi),
        Li)
      ) {
    ...
    ((_i = Na.selectors =
      {
        ...
        preFilter: {
          ATTR: function (e) {
            return (
              (e[1] = e[1].replace(xa, Sa)),
              (e[3] = (e[3] || e[4] || e[5] || "").replace(xa, Sa)),
              "~=" === e[2] && (e[3] = " " + e[3] + " "),
              e.slice(0, 4)
            );
          },
        ...
        filter: {
          ...
          PSEUDO: function (e, i) {
            var t,
              a =
                _i.pseudos[e] ||
                _i.setFilters[e.toLowerCase()] ||
                Na.error("unsupported pseudo: " + e);
            return a[Vi]
              ? a(i)
              : 1 < a.length
              ? ((t = [e, e, "", i]),
    ...
    (Ai = Na.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = _i.preFilter; a; ) {
          ...
          (r = fa.exec(a)) &&
            ((n = r.shift()),
            o.push({ value: n, type: r[0].replace(ca, " ") }),
            (a = a.slice(n.length))),
          _i.filter))
            _i.filter.hasOwnProperty(i) &&
              (!(r = ga[i].exec(a)) ||
                (s[i] && !(r = s[i](r))) ||
                ((n = r.shift()),
            ...
            (a = (function f(e) {
              for (
                ...
                if ((t = _i.relative[e[u].type])) l = [Oa(Ba(l), t)];
                  ...
                  if (
                    (t = _i.filter[e[u].type].apply(null, e[u].matches))[Vi]
                  ) {
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            Ui &&
            _i.relative[i[1].type]
          ) {
            if (!(t = (_i.find.ID(a.matches[0].replace(xa, Sa), t) || [])[0]))
              return n;
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
          }
          for (
            o = ga.needsContext.test(e) ? 0 : i.length;
            o-- && ((a = i[o]), !_i.relative[(u = a.type)]);

          )
            if (
              (s = _i.find[u]) &&
              (r = s(
                a.matches[0].replace(xa, Sa),
                (Ca.test(i[0].type) && Ta(t.parentNode)) || t
              ))
            ) {
        ...
        return (
          (c || Di(e, l))(r, t, !Ui, n, (Ca.test(e) && Ta(t.parentNode)) || t),
          n
        );
      }),
  ...
  (eu.fn = eu.prototype =
    {
      ...
      init: function (e, t) {
        ...
        if (Va(e)) {
          if (
            ...
            return lu(t).find(e);
          if (n[1])
            for (r = qa(e, iu(t)).firstChild; r; )
              Ma.call(o, r), (r = r.nextSibling);
          else {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (
            n = lu.unique(this.toArray().concat(lu.makeArray(e))),
      ...
      (Nu.prototype.loadScript = function (e, t, n) {
        ...
        (i.id = o),
          ...
          this.settings.referrerPolicy &&
            r.setAttrib(i, "referrerpolicy", this.settings.referrerPolicy),
          (i.onload = function () {
        ...
        !1 !== Du.languageLoad &&
          e(
            ...
            function () {
              ...
              !e ||
                (n && -1 === ("," + (n || "") + ",").indexOf("," + e + ",")) ||
                Su.ScriptLoader.add(s[t] + "/langs/" + e + ".js");
            },
            "loaded"
          );
      },
  ...
  var Ou,
    ...
    qu = function (e, t) {
      return (
        (n = t),
        (o = (r = e) === undefined ? document : r.dom),
        _t(o) ? [] : F(o.querySelectorAll(n), Nt.fromDom)
      );
      var n, r, o;
    },
    $u = N("mce-annotation"),
  ...
  var Ms,
      ...
      return i
        ? Hs(i)
          ? (function (e, t) {
              ...
              return (
                Hs(e) && t > e.data.length && (t = e.data.length), Us(e, t)
              );
            })(i, parseInt(o, 10))
    ...
    nc = function (e, t) {
      ...
      if (mo(e)) {
        if (
          (On(e) && lo(e) && (e = e.parentNode), (n = e.previousSibling), Js(n))
        )
          return n;
    ...
    rc = function (e, t, n) {
      ...
      var a,
        ...
        d,
        m =
          nc((a = i).startContainer, a.startOffset) ||
          nc(a.endContainer, a.endOffset);
      return m
        ? { name: (o = m.tagName), index: Zs(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
    ...
    ic = function (e, t) {
      ...
      var s,
        c = tc(r.cloneRange());
      i || (c.collapse(!1), (s = oc(n, o + "_end", t)), js(n, c, s)),
        (r = tc(r)).collapse(!0);
      ...
      return Nc(e) && t.container() === e
        ? ((r = t),
          ...
          0 < (o.text + i.text).length
            ? (_c(n), Us(n, r.offset() - o.count))
            : r)
        : Rc(e, t);
      var n, r, o, i;
    },
    Dc = function (e, t) {
      return Us.isTextPosition(t)
        ? Ac(e, t)
        : ((n = e), ((r = t).container() === n.parentNode ? Tc : Rc)(n, r));
      var n, r;
    },
    Oc = function (e) {
      Sc(e) && mo(e) && (po(e) ? e.removeAttribute("data-mce-caret") : Ec(e)),
      ...
      var n,
        ...
        f = function () {
          n = Fr.setInterval(function () {
            t()
              ? lu("div.mce-visual-caret", i).toggleClass(
                  "mce-visual-caret-hidden"
                )
              : lu("div.mce-visual-caret", i).addClass(
                  "mce-visual-caret-hidden"
                );
          }, 500);
        };
  ...
  var ll,
    ...
    bl = function (e, t) {
      if (0 < e) {
        if (gl(t.previousSibling) && !dl(t.previousSibling))
          return Us.before(t);
    ...
    Cl = function (e, t, n) {
      ...
      if (t.isEqual(Us.after(n)) && n.lastChild) {
        if (
          ((a = Us.after(n.lastChild)),
          e < 0 && gl(n.lastChild) && ml(n.lastChild))
        )
          return pl(n.lastChild) ? Us.before(n.lastChild) : a;
      } else a = t;
      var u,
        s,
        c,
      ...
      if (dl(l)) {
        ...
        if (e < 0 && 0 < f && ((o = yl(l, f - 1)), gl(o)))
          return !hl(o) && (i = Gc(o, e, vl, o))
            ? dl(i)
              ? Us(i, i.data.length)
              : Us.after(i)
            : dl(o)
        ...
        if (0 < e && f < l.childNodes.length && ((o = yl(l, f)), gl(o)))
          return pl(o)
            ? ((u = n),
              (c = (s = o).nextSibling) && gl(c)
                ? dl(c)
                  ? Us(c, 0)
                  : Us.before(c)
                : Cl(Ms.Forwards, Us.after(s), u))
            : !hl(o) && (i = Gc(o, e, vl, o))
            ? dl(i)
              ? Us(i, 0)
              : Us.before(i)
    ...
    El = function (e, t, n) {
      return e
        ? !Nl(t, n) &&
            ((r = t), !(!Us.isTextPosition(r) && In(r.getNode()))) &&
            Sl(t) &&
            xl(n)
        : !Nl(n, t) && xl(t) && Sl(n);
      var r;
    ...
    Tl = function (e, t) {
      ...
      return On(u)
        ? U.some(Us(u, e ? 0 : u.data.length))
        : u
        ? To(u)
          ? U.some(e ? Us.before(u) : In((a = u)) ? Us.before(a) : Us.after(a))
          : ((r = t),
            (o = u),
            (i = (n = e) ? Us.before(o) : Us.after(o)),
            kl(n, r, i))
        : U.none();
    },
    Al = E(kl, !0),
    ...
    Fl = function (e, t, n) {
      return (
        !(!1 !== t.hasChildNodes() || !Il(e, t)) &&
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(io)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        !0)
    ...
    Hl = function (e, t) {
      var n,
        ...
        h = e.dom;
      if (t) {
        if (((g = t), xt.isArray(g.start)))
          return (
            (m = t),
            (p = (d = h).createRng()),
            Ul(d, !0, m, p) && Ul(d, !1, m, p) ? U.some(p) : U.none()
          );
        ...
        if (t.hasOwnProperty("id"))
          return (
            ...
            as(a, u.or(a), function (e, t) {
              var n = o.createRng();
              return (
                n.setStart(Ml(o, e.container()), e.offset()),
                n.setEnd(Ml(o, t.container()), t.offset()),
                n
              );
            })
          );
      ...
      if (
        ...
        for (
          u < (i = s.childNodes).length
            ? ((s = i[u]), (r = new Hr(s, e.getParent(s, e.isBlock))))
            : ((s = i[i.length - 1]),
              (r = new Hr(s, e.getParent(s, e.isBlock))).next(!0)),
            o = r.current();
          o;
          o = r.next()
        )
          if (3 === o.nodeType && !ef(o))
    ...
    mf = function (e, t) {
      for (var n = t; n; ) {
        if (Nn(n) && e.getContentEditable(n))
    ...
    wf = function (e, t, n, r) {
      ...
      return (
        ...
        (n[0].inline || n[0].block_expand) &&
          ((n[0].inline && On(o) && 0 !== i) || (o = Cf(s, n, o, i, a, u, !0)),
          (n[0].inline && On(a) && u !== a.nodeValue.length) ||
            (a = Cf(s, n, o, i, a, u, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = yf(s, n, t, o, "previousSibling")),
          (a = yf(s, n, t, a, "nextSibling"))),
        (n[0].block || n[0].selector) &&
          ((o = bf(e, n, o, "previousSibling")),
          (a = bf(e, n, a, "nextSibling")),
          n[0].block &&
            (s.isBlock(o) || (o = Cf(s, n, o, i, a, u, !0)),
            s.isBlock(a) || (a = Cf(s, n, o, i, a, u, !1)))),
    ...
    Sf = function (e, t, u) {
      ...
      if (
        (1 === n.nodeType && n.hasChildNodes() && (n = xf(n, r)),
        1 === o.nodeType && o.hasChildNodes() && (o = xf(o, i - 1)),
        n === o)
      )
        return u(s([n]));
      ...
      return as(
        ...
        On(a)
          ? 0 === u
            ? U.some(Nt.fromDom(a))
            : U.none()
          : U.from(a.childNodes[u]).map(Nt.fromDom)),
        ((n = (t = e).endContainer),
        (r = t.endOffset),
        On(n)
          ? r === n.data.length
            ? U.some(Nt.fromDom(n))
            : U.none()
          : U.from(n.childNodes[r - 1]).map(Nt.fromDom)),
        function (e, t) {
          var n = K(Rf(o), E(Rt, e)),
            r = K(Tf(o), E(Rt, t));
    ...
    Df = function (e, t, n, r) {
      ...
      do {
        if (On(n) && 0 !== xt.trim(n.nodeValue).length)
  ...
  var Lf,
    ...
    Ff =
      ...
      (If = "text"),
      {
        get: function (e) {
          if (!Lf(e))
            throw new Error(
              "Can only get " + If + " value of a " + If + " node"
            );
          return Mf(e).getOr("");
        },
        ...
        set: function (e, t) {
          if (!Lf(e))
            throw new Error(
              "Can only set raw " + If + " value of a " + If + " node"
            );
          e.dom.nodeValue = t;
        },
      }),
    ...
    zf = function (r, o, i, a) {
      return jt(o).fold(
        ...
        function (e) {
          return "br" === a || (Lt((n = o)) && Uf(n) === io)
            ? "valid"
            : Pt((t = o)) && Hu(t, $u())
            ? "existing"
            : Ll(o.dom)
            ? "caret"
            : Zl(r, i, a) && Zl(r, Dt(e), i)
            ? "valid"
            : "invalid-child";
          var t, n;
        }
  ...
  var Wf,
      ...
      var f,
        ...
        n = function (e) {
          ...
          !(function (e, t) {
            if ("longpress" !== e.type && 0 !== e.type.indexOf("touch"))
              return D(e.target) && !Yf(e.clientX, e.clientY, t);
            var n = e.touches[0];
        ...
        L = function (e) {
          ...
          (w = s * p[2] + v),
            ...
            (s = T.scrollWidth - S) + (c = T.scrollHeight - N) !== 0 &&
        ...
        o = function (e) {
          ...
          C ||
            ...
            n((t = E.$(t).closest("table,img,figure.image,hr")[0]), T) &&
    ...
    od = function (e, t, n) {
      for (
        var r = new Hr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot());
        (t = r[n ? "prev" : "next"]());
    ...
    ad = function (e, t, n, r) {
      ...
      if (
        (Nn(l) && f > l.childNodes.length - 1 && (p = !1),
        Pn(l) && ((l = s), (f = 0)),
        l === s)
      ) {
        ...
        if (l.hasChildNodes()) {
          if (
            ...
            (l = l.childNodes[f]),
            (f = On(l) && d ? l.data.length : 0),
            !t && l === s.lastChild && rd(l))
          )
            return U.none();
          if (
            (function (e, t) {
      ...
      return (
        t === r && On(t)
          ? 0 < n &&
            ...
            ((t = (r = sd(t, n)).previousSibling),
            n < o
              ? ((t = r = sd(r, (o -= n)).previousSibling),
          ...
          : (On(t) &&
            ...
            On(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = sd(r, o).previousSibling).nodeValue.length)),
  ...
  ((Wf = ld = ld || {}).compareRanges = td),
    (Wf.getCaretRangeFromPoint = ed),
    (Wf.getSelectedNode = ps),
    (Wf.getNode = gs);
  var fd = ld;
  var dd,
    md,
    ...
    vd =
      ...
      }),
      {
        set: function (e, t) {
          if (!D(t) && !t.match(/^[0-9]+$/))
            throw new Error(
              dd + ".set accepts only positive integer values. Value was " + t
            );
          var n = e.dom;
    ...
    Ed = function (e, t, n, r, o) {
      ...
      (i = u),
        e.fire("ScrollIntoView", i).isDefaultPrevented() ||
          (n(t, vn(t).top, r, o), (a = u), e.fire("AfterScrollIntoView", a));
    },
    kd = function (e, t, n, r) {
    ...
    Od = function (e, t, n, r) {
      ...
      i.top < a.y
        ? bn(n.element, !1 !== r)
        : i.top > a.bottom && bn(n.element, !0 === r);
    },
    Bd = function (e, t, n) {
      return Nd(e, Dd, t, n);
    },
    ...
    Ud = function (e) {
      return (
        ...
        U.from(e.dom.activeElement).map(Nt.fromDom)
      );
    },
    zd = function (e, t, n, r) {
    ...
    Kd = function (e) {
      return qd.range(
        e.start,
        Wd(e.soffset, e.start),
        e.finish,
        Wd(e.foffset, e.finish)
      );
    },
    Xd = function (e, t) {
    ...
    tm = function (r) {
      return (r.bookmark ? r.bookmark : U.none())
        .bind(function (e) {
          return (
            (t = Nt.fromDom(r.getBody())),
            (n = e),
            U.from(n).filter(Yd(t)).map(Kd)
          );
          var t, n;
        })
        .bind(Zd);
    ...
    sm = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (im.unbind(document, "focusin", hd), (hd = null));
    },
    cm = function (t, e) {
      return (
        (n = e).collapsed
          ? U.from(gs(n.startContainer, n.startOffset)).map(Nt.fromDom)
          : U.none()
      ).bind(function (e) {
    ...
    pm = function (e) {
      return e.inline
        ? (n = e.getBody()) && dm(Nt.fromDom(n))
        : (t = e).iframeElement && Fd(Nt.fromDom(t.iframeElement));
      var t, n;
    },
    gm = function (t) {
      var e = t.selection,
      ...
      t.inline || (vt.opera || fm(n), t.getWin().focus()),
        (vt.gecko || t.inline) && (fm(n), lm(t, r)),
        hm(t);
    },
    hm = function (e) {
    ...
    Em =
      ...
      (km.prototype.getAll = function (e) {
        for (var t = [], n = this.firstChild; n; n = Sm(n, this))
          n.name === e && t.push(n);
        return t;
      }),
        ...
        if (r)
          do {
            ...
            if (
              ...
              return !1;
            if (3 === r.type && r.parent && t[r.parent.name] && Bo(r.value))
              return !1;
            if (n && n(r)) return !1;
          } while ((r = Sm(r, this)));
        return !0;
      ...
      n = function (m, e) {
        ...
        for (
          ...
          if ((x < t.index && A(E(w.substr(x, t.index - x))), (n = t[7])))
            ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), T(n);
          else if ((n = t[8])) {
            ...
            ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)),
              (u = n in I),
              j && M[n] && 0 < S.length && S[S.length - 1].name === n && T(n);
            var $ = (function (e, t) {
              var n = e.exec(t);
              if (n) {
                var r = n[1],
  ...
  var Bm,
    ...
    Fm = function (e, t, n, r) {
      ...
      if (
        ...
        o = xt.trim(Mm(e.serializer, r.innerHTML));
    ...
    qm = function (e) {
      ...
      return (
        On(t) &&
        (0 === t.data.length || (ao(t.data) && Kf.isBookmarkNode(t.parentNode)))
      );
    },
    $m = function (t, n) {
      return function (e) {
    ...
    Km = function (e) {
      return (
        Un(e) && !(Nn((t = e)) && "all" === t.getAttribute("data-mce-bogus"))
      );
      var t;
    },
    Xm = $m(!0, Wm),
    ...
    np = function (e) {
      var t = qu(e, "br"),
        n = j(
          (function (e) {
            for (var t = [], n = e.dom; n; )
              t.push(Nt.fromDom(n)), (n = n.lastChild);
            return t;
          })(e).slice(-1),
          Gr
        );
    ...
    bp = function (e, t) {
      return (
        (n = t),
        U.from(n.getNode(!0)).map(Nt.fromDom).exists(Gr) ||
          vp(!1, e, t).isSome()
      );
      var n;
    },
    ...
    Ap = function (e, t) {
      return (
        ...
        Tp(
          ...
          ((r = (n = t).container()),
          (o = n.offset()),
          On(r) && o < r.data.length ? Is(r, o + 1) : n)
        )
      );
      var n, r, o;
    },
    ...
    Pp = function (l, e) {
      return U.some(e)
        ...
        .bind(function (e) {
          ...
          (u = (a = c).data),
          (s = Is(a, 0)),
          !(!Dp(u, 0) || Ap(i, s) || ((a.data = " " + u.slice(1)), 0)) ||
            Bp(c) ||
            ((t = l),
            (r = (n = c).data),
            (o = Is(n, r.length - 1)),
    ...
    zp = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === Us.isTextPosition(n) &&
        o === r.parentNode &&
        i > Us.before(r).offset()
          ? Us(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    jp = function (e) {
      return To(e.previousSibling)
        ? U.some(
            ((t = e.previousSibling),
            On(t) ? Us(t, t.data.length) : Us.after(t))
          )
        : e.previousSibling
        ? Bl(e.previousSibling)
        : U.none();
      var t;
    },
    Hp = function (e) {
      return To(e.nextSibling)
        ? U.some(((t = e.nextSibling), On(t) ? Us(t, 0) : Us.before(t)))
        : e.nextSibling
        ? Ol(e.nextSibling)
        : U.none();
      var t;
    ...
    cg = function (n) {
      return as(
        ug((r = n).cells, r.rng.start),
        ug(r.cells, r.rng.end),
        function (e, t) {
    ...
    lg = function (e, t) {
      var n,
        ...
        s =
          ((o = u),
          (i = Zp((r = t).startContainer, o)),
          (a = Zp(r.endContainer, o)),
          as(i, a, Jp));
      return sg(s, t, u)
        .map(function (e) {
      ...
      return vg(s, r).fold(
        ...
        function (e) {
          return (
            ...
            (Uo(o) ? yg(t, o) : bg(t, r, n, o, i)).getOr(!1)
          );
          var t, n, r, o, i;
        }
      );
    ...
    Sg = function (e, t) {
      ...
      return e.selection.isCollapsed() && 0 === s.length
        ...
        : ((n = e),
          (r = u),
          (o = Nt.fromDom(n.getBody())),
          (i = n.selection.getRng()),
          0 !== (a = _f(n)).length ? dg(n, a) : gg(n, o, i, r));
    },
    Ng = function (a) {
    ...
    Rg = function (e) {
      return (
        ...
        ((t = e.firstChild).data === oo || In(t))
      );
      var t;
    },
    Tg = function (e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Rg(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    Lg = function (e) {
      ...
      (r = t),
        (o = n),
        null !== (i = a) &&
        i === r.getParent(o.endContainer, Pg) &&
        Af(Nt.fromDom(i), o)
          ? mg(e, n, Nt.fromDom(a))
    ...
    Ig = function (e, t, n) {
      ...
      /^ | $/.test(t) &&
        ...
        (l = Rp(f, Us.fromRangeStart(c))
          ? l.replace(/^ /, "&nbsp;")
          : l.replace(/^&nbsp;/, " ")),
        (t = l =
          Tp(f, Us.fromRangeEnd(c))
            ? l.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
            : l.replace(/&nbsp;(<br( \/)?>)?$/, " ")));
      var p = e.parser,
        g = n.merge,
      ...
      if ((y = e.fire("BeforeSetContent", y)).isDefaultPrevented())
        ...
        var S,
          ...
          F = p.parse(t, M);
        if (!0 === n.paste && _g(e.schema, F) && Ag(m, r))
          return (
            (a = Bg(h, m, d.getRng(), F)),
            d.setRng(a),
        ...
        (T = g),
          ...
          T &&
            ...
            xt.each(B.select("*[data-mce-fragment]"), function (e) {
              for (var t = e.parentNode; t && t !== A; t = t.parentNode)
        ...
        U.from(u.getBody()).fold(N(s), function (e) {
          return Ug(s)
            ? (function (e, t, n, r) {
                ...
                return (
                  (r.content = no(Nt.fromDom(t)) ? o : xt.trim(o)),
                  zg(e, r.content),
                ...
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r =
                    ...
                    t.schema.isValidChild(
                      ...
                      ? ((r = a), t.dom.createHTML(i, dc(t), r))
                      : r || '<br data-mce-bogus="1">'),
                  zg(t, r),
                  t.fire("SetContent", o))
                : ("raw" !== o.format &&
                    (r = Tm({ validate: t.validate }, t.schema).serialize(
        ...
        if ("undefined" == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (
                ((u = "attributes" === r ? e.getAttrib(t, a) : of(e, t, a)),
                o && !u && !n.exact)
              )
                return;
          ...
          for (s = 0; s < c.length; s++)
            if ("attributes" === r ? e.getAttrib(t, c[s]) : of(e, t, c[s]))
              return n;
      return n;
    },
    ...
    Gg = function (e, t) {
      ...
      if (u)
        for (
          n = e.selection.getStart(), r = uf(s, n), i = u.length - 1;
          0 <= i;
          i--
        ) {
      ...
      i &&
        (o
          ...
          : ((s = Il(e.getBody(), i)),
            ...
            (p = null !== s ? s : i),
            (g = (d = e).dom),
            (h = g.getParent(p, E(Ql, d))) && g.isEmpty(h)
    ...
    sh = function (i) {
      i.on("mouseup keydown", function (e) {
        ...
        (t = i),
          ...
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== Qg ||
            oh(t, Il(o, r.getStart())),
          (37 !== n && 39 !== n) || oh(t, Il(o, r.getStart()));
      });
    },
    ch = function (e, t) {
      return (
        e.schema.getTextInlineElements().hasOwnProperty(Dt(t)) &&
        !Ll(t.dom) &&
        !Rn(t.dom)
      );
    },
  ...
  var mh = xt.each,
    ...
    Dh = function (e, r, o, t, i) {
      ...
      if (
        ...
        !(
          Nh((s = t), (c = r).inline) ||
          Nh(s, c.block) ||
          (c.selector && Nn(s) && u.is(s, c.selector)) ||
      ...
      if ("all" !== r.remove) {
        Sh(r.styles, function (e, t) {
          (e = rf(l, tf(e, o), t + "")),
            D(t) && ((t = e), (i = null)),
            (!r.remove_similar && i && !Nh(of(l, i, t), e)) ||
              l.setStyle(y, t, ""),
            (n = !0);
        }),
          n &&
          ...
          Sh(r.attributes, function (e, t) {
            ...
            if (
              ((e = tf(e, o)),
              D(t) && ((t = e), (i = null)),
              r.remove_similar || !i || Nh(l.getAttrib(i, t), e))
            ) {
              if (
                "class" === t &&
                (e = l.getAttrib(y, t)) &&
              ...
              "class" === t && y.removeAttribute("className"),
                xh.test(t) && y.removeAttribute("data-mce-" + t),
                y.removeAttribute(t);
            }
          }),
          ...
          m.block &&
            (v
              ...
              : h.isBlock(d) &&
                !h.isBlock(g) &&
                (Ah(h, d, !1) ||
                  Ah(h, d.firstChild, !0, !0) ||
                  d.insertBefore(h.create("br"), d.firstChild),
                Ah(h, d, !0) ||
                  Ah(h, d.lastChild, !1, !0) ||
    ...
    Ph = function (s, c, l, e, f) {
      ...
      if (e)
        ...
        for (
          var o = 0;
          o < d.length && (!d[o].ceFalseOverride || !Oh(s, d[o], l, e, e));
          o++
        );
      }
    },
    ...
    Fh = function (E, k, _, r) {
              ...
              var u,
                s = function (e) {
                  ...
                  if (
                    ...
                    return (u = 0), void (T.block && S.remove(e));
                  if (T.wrapper && Kg(E, e, k, _)) u = 0;
                    ...
                    Ll(e) ||
                    (T.inline && S.isBlock(e))
                      ? ((u = 0),
                        Mh(xt.grep(e.childNodes), s),
                        t && (l = n),
                        (u = 0))
                      : (u ||
                          ((u = S.clone(d, !1)),
                ...
                ? (T.inline || T.wrapper) &&
                  ...
                  (l = T).styles &&
                    ...
                    yh(
                      d,
                      bh(c, "fontSize"),
                      Ch(c, "backgroundColor", tf(l.styles.backgroundColor, f))
                    ),
                  (i = S),
                  (u = e),
                  (s = function (e) {
                  ...
                  (a = T).styles &&
                    ...
                    (xt.walk(u, s, "childNodes"), s(u)),
                  (t = S),
                  (o = e),
                  ("sub" !== (r = T).inline && "sup" !== r.inline) ||
                    (yh(o, bh(t, "fontSize"), Ch(t, "fontSize", "")),
                    t.remove(
      ...
      if ("false" !== i.getContentEditable(a.getNode())) {
          ...
          (r
            ...
            : ((t = a.getNode()),
              E.settings.forced_root_block ||
                !R[0].defaultBlock ||
                i.getParent(t, i.isBlock) ||
                Fh(E, R[0].defaultBlock),
        ...
        for (var s = 0, c = R.length; s < c; s++)
          if (R[s].ceFalseOverride && i.is(r, R[s].selector))
            return void A(r, R[s]);
      }
    },
    Uh = function (e, t) {
    ...
    ev = function (e, t) {
      ...
      return 0 < o.length
        ? Zh(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? Jh() : Qh(n, r[0]));
    },
    tv = function (e, t) {
      ...
      return {
        undoManager: {
          beforeChange: function (e, t) {
            return (
              (n = f), (r = t), void (pv(e) && r.set(U.some(uc(n.selection))))
            );
            var n, r;
          },
          ...
          undo: function (e, t, n) {
            return (
              ...
              (i = t),
              (a = n),
              (o = e).typing && (o.add(), (o.typing = !1), gv(o, !1, i)),
              0 < a.get() &&
                (a.set(a.get() - 1),
                (u = o.data[a.get()]),
                lv(r, u, !0),
          ...
          hasUndo: function (e, t) {
            return (
              (n = f),
              (r = e),
              0 < t.get() || (r.typing && r.data[0] && !mv(cv(n), r.data[0]))
            );
            var n, r;
          },
          ...
          transact: function (e, t, n) {
            return (
              (o = n), hv((r = e), t), r.beforeChange(), r.ignore(o), r.add()
            );
            var r, o;
          },
          ignore: function (e, t) {
        ...
        formatter: {
          ...
          toggle: function (e, t, n) {
            return (
              ...
              void (
                !Xg(r, o, i, a) || ("toggle" in u[0] && !u[0].toggle) ? Fh : Ph
              )(r, o, i, a)
            );
            var r, o, i, a, u;
          },
          ...
          getContent: function (e, t) {
            return (
              ...
              U.from(n.getBody()).fold(
                N("tree" === r.format ? new Em("body", 11) : ""),
                function (e) {
                  return Fm(n, r, o, e);
                }
              )
    ...
    wv = function (i, a) {
      ...
      return {
        ...
        editor: {
          getContent: function (e, t) {
            if ("html" !== t && "tree" !== t)
              return Cv(i).editor.getContent(e, t);
            var n = a.getContent(),
              r = Tm({ inner: !0 });
        ...
        selection: {
          getContent: function (e, t) {
            if ("html" !== e && "tree" !== e)
              return Cv(i).selection.getContent(e, t);
        ...
        return (
          ...
          t.filter(Lt).map(function (e) {
            return (
              ...
              void (r
                ? (Up(o, i, !1, !r), n.setStart(i, a))
                : (Up(i, o, !1, !r), n.setEnd(i, a)))
            );
            var t, n, r, o, i, a;
          })
        );
        ...
        t
          ...
          return (
            ...
            void jt((n = e)).each(function (e) {
              ...
              r && Rp(e, Us(t, 0))
                ? Mp(t, 0)
                : !r && Tp(e, Us(t, t.length)) && Fp(t, t.length);
            })
          );
          var n, r;
        });
      ...
      i.no_events || !(i = e.fire("BeforeSetContent", i)).isDefaultPrevented()
        ? ((n.content = (function (e, t) {
            ...
            var n = e.selection.getRng(),
              ...
              i = e.parser.parse(
                t.content,
                xe(xe({ isRootContent: !0, forced_root_block: !1 }, o), t)
              );
  ...
  var Av = function (e) {
    ...
    Dv = function (e) {
      return (
        !(!e || !e.ownerDocument) &&
        At(Nt.fromDom(e.ownerDocument), Nt.fromDom(e))
      );
    },
    Ov = function (u, s, e, c) {
      var l,
        ...
        g = function (e, t) {
          ...
          if (
            (r = e) &&
            (Av(r) || (Dv(r.startContainer) && Dv(r.endContainer)))
          ) {
            var r,
              o = Av(e) ? e : null;
            if (o) {
        ...
        v = {
          ...
          getNode: function () {
            return (function (e, t) {
              ...
              return !t.collapsed &&
                ...
                3 === n.nodeType &&
                  3 === r.nodeType &&
                  ((n = n.length === o ? Cm(n.nextSibling, !0) : n.parentNode),
                  (r = 0 === i ? Cm(r.previousSibling, !1) : r.parentNode),
                  n && n === r))
                ? n
                : a && 3 === a.nodeType
                ? a.parentNode
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              var o,
                ...
                a = e.getRoot();
              if (
                ((n = e.getParent(n || ym(a, t, t.collapsed), e.isBlock)),
                (r = e.getParent(r || bm(a, t, t.collapsed), e.isBlock)),
                n && n !== a && i.push(n),
                n && r && n !== r)
              )
                for (var u = new Hr((o = n), a); (o = u.next()) && o !== r; )
          ...
          getBoundingClientRect: function () {
            var e = p();
            return e.collapsed
              ? Us.fromRangeStart(e).getClientRects()[0]
    ...
    Pv = function (e, t) {
      ...
      t.convert_fonts_to_spans &&
        Bv(e, r, xt.explode(t.font_size_legacy_values)),
        (n = r),
  ...
  var Hv,
    ...
    qv = function (e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new Em("br", 1)).shortEnded = !0)
        : (r.empty().append(new Em("#text", 3)).value = oo);
    },
    $v = function (e, t) {
      return (
        e &&
          ...
          for (d.body = 1, r = 0; r < f; r++)
            if (
              ...
              a === i &&
                ...
                (((l = new Em("#text", 3)).value = oo), o.replace(l));
            }
        }),
      ...
      var e,
        ...
        n = {
          ...
          parse: function (e, u) {
            ...
            var f,
              d = Qv(
                Yv("script,style,head,html,body,title,meta,param"),
                T.getBlockElements()
              ),
              ...
              E = function (e) {
                for (
                  var t, n, r, o = T.getBlockElements(), i = e.prev;
                  i && 3 === i.type;
              ...
              k = Lm(
                {
                  ...
                  start: function (e, t, n) {
                    ...
                    if (a) {
                      ...
                      if (
                        (S && y[e] && (S = !1), a.removeEmpty && Wv(T, m, y, c))
                      )
                        return (
                          (o = c.parent),
                      ...
                      a.paddEmpty &&
                        (($v((i = c), "#text") && i.firstChild.value === oo) ||
                          Wv(T, m, y, c)) &&
                        qv(R, u, d, c),
                        (c = c.parent);
                    }
                          ...
                          if (p[t.name] && "li" === t.parent.name) {
                            ...
                            if (n && 1 < r.length) {
                              for (
                                ...
                                for (
                                  T.isValidChild(i.name, r[s].name)
                              ...
                              T.isValidChild(t.parent.name, "div") &&
                              T.isValidChild("div", t.name)
                                ? t.wrap(P(new Em("div", 1)))
                                : g[t.name]
                                ? t.empty().remove()
                                : t.unwrap();
                            }
                    ...
                    for (; n; )
                      (e = n.next),
                        ...
                        (1 === n.type &&
                          ...
                          ? (t ||
                              ((t = N(v, 1)).attr(R.forced_root_block_attrs),
                              _.insert(t, n)),
                            t.append(n))
                          : (r(t), (t = null)),
                        (n = e);
      ...
      (s = y),
        ...
        t.addNodeFilter("noscript", function (e) {
          for (var t, n = e.length; n--; )
            (t = e[n].firstChild) && (t.value = ri.decode(t.value));
        }),
        ...
        serialize: function (e, t) {
          ...
          var n,
            ...
            h =
              ((n = C),
              (r = g),
              (i = uo((o = p).getInner ? r.innerHTML : n.getOuterHTML(r))),
              o.selection || no(Nt.fromDom(r)) ? i : xt.trim(i)),
            v =
              ((a = x),
              (u = h),
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              uy.unbind(r, "submit reset", n.formEventDelegate)),
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              s && s.external_plugins
                ? xt.extend({}, s.external_plugins, l)
                : l),
          }
        );
      return Sy(e, m, r, p);
      ...
      var n,
        ...
        g = function (e, t, n) {
          var r =
            ...
            n +
            '"' +
            (n === vt.transparentSrc ? ' data-mce-placeholder="1"' : "");
          return (
            (e = p(e, 'src="' + t + '"', r)),
                          ...
                          s.getParam("images_replace_blob_uris", !0, "boolean")
                            ...
                            : e.error &&
                              (e.error.options.remove &&
                                (h(i.getAttribute("src"), vt.transparentSrc),
                                a.push(i)),
                              (n = s),
                              (r = e.error.message),
                              Hy(
                                n,
                                Au.translate(["Failed to upload image: {0}", r])
                              )),
                          {
                            element: i,
                            status: e.status,
  ...
  var nb,
    ...
    ab = function (e, t) {
      var n,
        ...
        p = function (e) {
          ...
          return (
            (t = r),
            (n = o).classes.length && ib.addClass(t, n.classes.join(" ")),
            ib.setAttribs(t, n.attrs),
            r
          );
        },
        g = function (n, e, t) {
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = p(o)),
          (r = ib.create("div")).appendChild(g(n, e.slice(1), o.siblings)),
          r)
        : "";
    },
    ub = function (e) {
      ...
      var c,
        l =
          (c = e.selector) && "string" == typeof c
            ...
            : [],
        f = l.length
          ? (l[0].name || (l[0].name = t), (t = e.selector), ab(l, n))
          : ab([t], n),
          ...
          if (
            !(
              ("background-color" === e &&
                ...
                ((t = ib.getStyle(n.getBody(), e, !0)),
                "#ffffff" === ib.toHex(t).toLowerCase())) ||
            ...
            ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
              ...
              : ((t = (e.ctrlKey && !e.altKey) || e.metaKey),
                !(n < 16 || 20 < n) ||
                  ...
                  r.typing ||
                  t ||
                  (r.beforeChange(), gv(r, !0, o), r.add({}, e), i.set(!0))));
        }),
        ...
        d = {
          ...
          add: function (e, t) {
            return (
              ...
              (a = e),
              (u = t),
              Nv(s).undoManager.addUndoLevel(n, r, o, i, a, u)
            );
            var n, r, o, i, a, u;
          },
          undo: function () {
          ...
          transact: function (e) {
            return (
              (t = d), (n = l), (r = e), Nv(s).undoManager.transact(t, n, r)
            );
            var t, n, r;
          },
          ignore: function (e) {
          ...
          extra: function (e, t) {
            ...
            (n = d),
              ...
              (o = e),
              (i = t),
              Nv(s).undoManager.extra(n, r, o, i);
          },
        };
      return (
        xv(s) || lb(s, d, l),
    ...
    hb = function (a) {
      var e,
        ...
        c = (e = a).getParam(
          "placeholder",
          sc.getAttrib(e.getElement(), "placeholder"),
          "string"
        ),
        l = function (e, t) {
          var n, r, o, i;
          !(function (e) {
            ...
            (r =
              !(
                pb((o = e)) &&
                !(gb(o) || ("keyup" === o.type && 229 === o.keyCode))
              ) &&
              (function (e, t, n) {
    ...
    bb = function (e) {
      return (
        "rtl" === bu.DOM.getStyle(e, "direction", !0) ||
        ((t = e.textContent), vb.test(t))
      );
      var t;
    },
    Cb = function (e, t, n) {
      var r,
        ...
        a =
          ...
          (o = t),
          (i = n),
          j(bu.DOM.getParents(i.container(), "*", o), r));
    ...
    Lb = function (e, t, n) {
      return (
        Pb(!0, t), Pb(!1, n), Bb(t, n).fold(E(Ob, e, t, n), E(Db, e, t, n))
      );
    },
    Ib = function (e, t, n, r) {
    ...
    Mb = function (t, n) {
      var e,
        ...
        a =
          ((e = i.dom),
          (r = n),
          ((o = t.selection.getRng()).collapsed ? Rb(e, r, o) : U.none()).bind(
            function (e) {
    ...
    Ub = function (e, t) {
      ...
      return (
        !(Fb((n = e), (r = t).startContainer) || Fb(n, r.endContainer)) &&
        o &&
        i
      );
    },
    zb = function (e) {
      ...
      return Ub(i, a)
        ...
        : ((n = i),
          ...
          (o = r.getRng()),
          as(
            Nb(n, Nt.fromDom(o.startContainer)),
            Nb(n, Nt.fromDom(o.endContainer)),
            function (e, t) {
              return (
                !1 === Rt(e, t) &&
                (o.deleteContents(),
      ...
      return (
        ...
        Nn(a) && a.getAttribute("data-mce-caret") === u
          ? ((t = e),
            (n = o.getNode(!1 === e)),
            (t && Un(n.nextSibling)
              ? U.some(Qb.moveToElement(n.nextSibling))
              : !1 === t && Un(n.previousSibling)
              ? U.some(Qb.moveToElement(n.previousSibling))
              : U.none()
            ).fold(function () {
              return eC(r, e, o);
            }, U.some))
        ...
        nC(t, e.parentNode)
          ...
          .fold(
            function () {
              var e;
              return (
                (e = Nt.fromDom(t.getBody())),
                $(qu(e, ".mce-offscreen-selection"), ln),
                Gp(t, n, Nt.fromDom(t.selection.getNode())),
                Eb(t),
                !0
              );
            },
    ...
    dC = function (e, t) {
      return (
        e
          ? function (e) {
              if (sC(e.previousSibling))
                return (
                  lC(e.previousSibling) || e.previousSibling.appendData(io),
                  e.previousSibling
                );
          ...
          : function (e) {
              if (sC(e.nextSibling))
                return (
                  cC(e.nextSibling) || e.nextSibling.insertData(0, io),
                  e.nextSibling
                );
    ...
    LC = function (e, t) {
      return e
        ? t.fold(a(U.some, bC.start), U.none, a(U.some, bC.after), U.none)
        : t.fold(U.none, a(U.some, bC.before), U.none, a(U.some, bC.end));
    },
    IC = function (e, a, u, s) {
      var t = wb(e, s),
        c = RC(a, u, t);
    ...
    MC =
      ...
      function (e, t, n) {
        var r = e ? 1 : -1;
        return (
          t.setRng(Us(n.container(), n.offset() + r).toRange()),
    ...
    YC = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          RC(s, u, Us.fromRangeStart(r.selection.getRng()))
            .map(OC)
            .map(XC(r, o));
      }),
        r.nodeChanged();
    ...
    GC = function (n, r, i, o) {
      ...
      return s
        .bind(function (e) {
          return i
            ? e.fold(N(U.some(OC(e))), U.none, N(U.some(DC(e))), U.none)
            : e.fold(U.none, N(U.some(DC(e))), U.none, N(U.some(OC(e))));
        })
        .map(XC(n, r))
        .getOrThunk(function () {
          var t = _l(i, a, o),
    ...
    iw = function (e, t) {
      return (
        (e || "table" === Dt(t) ? "margin" : "padding") +
        ("rtl" === Yn(t, "direction") ? "-right" : "-left")
      );
    },
    aw = function (e) {
      var r,
      ...
      e.queryCommandState("InsertUnorderedList") ||
        ...
        $(sw(e), function (e) {
          ...
          (t = l),
            ...
            (s = iw(r, Nt.fromDom(a))),
            "outdent" === n
              ? ((u = Math.max(0, ow(a.style[s]) - o)),
                t.setStyle(a, s, u ? u + i : ""))
              : ((u = ow(a.style[s]) + o + i), t.setStyle(a, s, u));
        });
    },
    lw = function (e, t) {
              ...
              if (
                (function (e, t) {
                  if (On(t)) {
                    ...
                    if (
                      /^\s+$/.test(t.nodeValue) &&
                      (!t.nextSibling || gw(e, t.nextSibling))
                    )
                      return !0;
                  }
                  return !1;
    ...
    yw = function (e, t) {
      var n,
        r =
          ((n = e),
          Er(Nt.fromDom(n.getBody()), "*[data-mce-caret]").fold(
            N(null),
            function (e) {
              return e.dom;
            }
      ...
      if (r)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void vw(e, r))
          : void (po(r) && (vw(e, r), e.undoManager.add()));
    };
  ((rb = nb = nb || {})[(rb.Br = 0)] = "Br"),
    (rb[(rb.Block = 1)] = "Block"),
    (rb[(rb.Wrap = 2)] = "Wrap"),
      ...
      for (
        ...
        if (In(o.getNode(!1)))
          return t === Ms.Forwards
            ...
            : { positions: ww(t, d), breakType: nb.Br, breakAt: U.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
            var m =
              ((i = t),
              (a = f),
              In((u = o).getNode(i === Ms.Forwards))
                ? nb.Br
                : !1 === Qc(a, u)
                ? nb.Block
                : nb.Wrap);
  ...
  var Ow = function (o, i, a, e, u, t) {
    ...
    Vw = function (e, o) {
      return be(e, function (e, t) {
        ...
        return jw(o, t) || (!jw(o, e) && ((r === n && Mw(t.node)) || r < n))
          ? t
          : e;
      });
    },
        ...
        if (
          (u = Vw(
            (function (e, r, t) {
              ...
              return (
                o.push(r),
                qw(bw.Up, e, E(n, fs), r.node, t),
                qw(bw.Down, e, E(n, ds), r.node, t),
                o
              );
            })(e, u, s),
            t
      ...
      if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : ps(n))) {
        var h = (function (e, t, n, r) {
            var o,
              ...
              d =
                1 === e
                  ? ((o = s.next), (i = ds), (a = fs), Us.after(r))
                  : ((o = s.prev), (i = fs), (a = ds), Us.before(r)),
              m = f(d);
            do {
              if (d.isVisible() && !a((u = f(d)), m)) {
                if (
                  (0 < c.length && i(u, we(c)) && l++,
                  ((u = ss(u)).position = d),
                  (u.line = l),
                  n(u))
                )
    ...
    Zw = function (e, t, n) {
      ...
      if (n.collapsed && "" !== fc(e)) {
        ...
        a(Us.fromRangeStart(n)) ||
          ((o = (r = e).dom.create(fc(r))),
          (!vt.ie || 11 <= vt.ie) && (o.innerHTML = '<br data-mce-bogus="1">'),
          (u = o),
    ...
    sx = function (e, t, n, r) {
      return "" === t
        ? ((l = e), (f = r), (d = Nt.fromTag("br")), ux(l, d, f), ax(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    cx = function (e, t, n) {
      return t
        ? ((o = e.dom), _w(o, n).breakAt.isNone())
        : ((r = e.dom), kw(r, n).breakAt.isNone());
      var r, o;
    },
    lx = function (t, n) {
      var e,
    ...
    Nx = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === nb.Wrap && 0 === a.positions.length) ||
        (!In(n.getNode()) &&
          (i = u).breakType === nb.Br &&
    ...
    jx = function (e, t, n) {
      for (var r = e[n ? "firstChild" : "lastChild"]; r && !Nn(r); )
    ...
    Wx = function (e, t, n) {
      return !1 === On(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === io
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === io
        ? t.data.length
        : n;
    },
    Kx = function (e, t) {
          ...
          : (N && s === a.getBody()) ||
            ...
            lo(s)
              ...
              : ((S = (x = p).cloneRange()).setStart(
                  x.startContainer,
                  Wx(!0, x.startContainer, x.startOffset)
                ),
    ...
    Qx = function (e, t) {
      ...
      "LI" !== d || m || (l = f),
        c &&
          ...
          !(function (e, t, n) {
            for (
              var r, o = new Hr(t, n), i = e.getNonEmptyElements();
              (r = o.next());
    ...
    eS = function (e, t) {
      ...
      var n = Nt.fromTag("br");
      on(Nt.fromDom(t), n),
        Gx(e.dom, e.selection, n.dom),
        Jx(e.dom, e.selection, n.dom, !1),
        e.undoManager.add();
    },
    tS = function (e, t) {
      return (
    ...
    _S = function (r, o) {
      return function (e) {
        return (
          (t = r),
          (!kp((n = e)) && (_p(t, n) || Np(t, n) || Ep(t, n)) ? ES : kS)(o)
        );
        var t, n;
      };
    },
    ...
    TS = function (r) {
      r.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          px([{ keyCode: Gf.SPACEBAR, action: mx(RS, t) }], n).each(function (
            e
          ) {
            n.preventDefault();
          }));
    ...
    AS = function (e) {
      var t,
        n = $C(e);
      return (
        (t = e).on("keyup compositionstart", E(yw, t)),
        Px(e, n),
        Lx(e, n),
        CS(e),
        TS(e),
  ...
  function OS(r) {
    ...
    "onselectionchange" in r.getDoc() ||
      r.on("NodeChange click mouseup keyup focus", function (e) {
        ...
        ("nodechange" !== e.type && td(n, o)) || r.fire("SelectionChange"),
          (o = n);
      }),
      ...
      r.on("SelectionChange", function () {
        ...
        !e ||
          (!vt.range && r.selection.isCollapsed()) ||
          (Of(r) &&
  ...
  var BS = function (e) {
    ...
    HS = function (e, h) {
      ...
      return function (g) {
        return e.on(function (e) {
          ...
          if (!e.dragging && 10 < p) {
            if (h.fire("dragstart", { target: e.element }).isDefaultPrevented())
              return;
      ...
      $S(e),
        (n = e).on("drop", function (e) {
          var t =
            "undefined" != typeof e.clientX
              ...
              : null;
          (!FS(t) && "false" !== n.dom.getContentEditableParent(t)) ||
            e.preventDefault();
        }),
        e.getParam("block_unsupported_drop", !0, "boolean") &&
          ((a = function (e) {
            ...
            e.defaultPrevented ||
              ((t = e.dataTransfer) &&
                (I(t.types, "Files") || 0 < t.files.length) &&
                (e.preventDefault(),
                "drop" === e.type &&
                  Hy(i, "Dropped file type is not supported")));
          }),
          (u = function (e) {
            am(i, e.target) && a(e);
          }),
    ...
    GS = function (u) {
      var s,
        ...
        C = function (e) {
          ...
          var r = (function (e, t, n) {
              ...
              t === n && vt.ie
                ? (o
                  ...
                  i.setEndAfter(t))
                : (o.empty().append(oo).append(t).append(oo),
          ...
          return (
            $(
              qu(Nt.fromDom(u.getBody()), "*[data-mce-selected]"),
              function (e) {
                Rt(o, e) || Kn(e, i);
              }
            ),
        ...
        x = function () {
          s && s.removeAttribute(i),
            Er(Nt.fromDom(u.getBody()), "#" + p).each(ln),
            (s = null);
        },
        S = function () {
          m.hide();
        ...
        vt.ceFalse &&
          (function () {
            u.on("mouseup", function (e) {
              var t = r();
              t.collapsed &&
                Ly(u, e.clientX, e.clientY) &&
                Wb(u, t, !1).each(h);
            }),
              u.on("click", function (e) {
                var t = YS(u, e.target);
                t &&
                  (XS(t) && (e.preventDefault(), u.focus()),
                  KS(t) && l.isChildOf(t, c.getNode()) && x());
              }),
                ...
                (o !== d && "HTML" !== o.nodeName && !l.isChildOf(o, d)) ||
                  ...
                  ((t = YS(u, o))
                    ? XS(t)
                      ...
                      : (x(),
                        (KS(t) && e.shiftKey) ||
                          Yf(e.clientX, e.clientY, c.getRng()) ||
              ...
              (e = Pu(function () {
                ...
                n.removed ||
                  ...
                  ((e = n.selection.getRng()).collapsed &&
                    ((t = Kb(n, e, !1)), n.selection.setRng(t)));
              }, 0)),
        ...
        Ol(e).each(function (e) {
          ...
          vt.browser.isIE()
            ? ((t = u),
              (n = a.toRange()),
              (r = Nt.fromDom(t.getBody())),
              (o = (Gd(t) ? U.from(n) : U.none()).map(Jd).filter(Yd(r))),
    ...
    rN = function (t, e) {
      ...
      n.browser_spellcheck ||
        n.gecko_spellcheck ||
        ((r.body.spellcheck = !1), QS.setAttrib(o, "spellcheck", "false")),
        (t.quirks = JS(t)),
        t.fire("PostRender");
      var i,
        a,
    ...
    oN = function (t, e) {
      ...
      n.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.inline &&
          (QS.addClass(r, "mce-content-body"),
      ...
      (c.disabled = !0),
        ...
        t.readonly ||
          (t.inline &&
            "static" === QS.getStyle(c, "position", !0) &&
        ...
        (t.parser =
          ((i = Zv(eN((u = t)), u.schema)).addAttributeFilter(
          ...
          i.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
            for (var t = e.length, n = u.schema.getNonEmptyElements(); t--; ) {
              ...
              r.isEmpty(n) &&
                ...
                (r.append(new Em("br", 1)).shortEnded = !0);
            }
          }),
          i)),
        (t.serializer = oy(
    ...
    dN = function (e) {
      ...
      return e.inline
        ? fN(null)
        : ((t = r), (n = sN.create("div")), sN.insertAfter(n, t), fN(n));
    },
    mN = function (e) {
      var t,
        n,
    ...
    pN = function (e) {
      ...
      e.fire("ScriptsLoaded"),
        ...
        (u = Cc((i = e))),
        q(u)
          ? ((i.settings.theme = lN(u)),
            (a = Uy.get(u)),
            (i.theme = new a(i, Uy.urls[u])),
            i.theme.init &&
              i.theme.init(
                i,
                Uy.urls[u] || i.documentBaseUrl.replace(/\/$/, ""),
                i.$
              ))
          : (i.theme = {}),
        (s = e),
      ...
      return (
        ...
        e.inline
          ...
          : ((p = uN((d = e), (m = g))),
            m.editorContainer &&
              ((iN.get(m.editorContainer).style.display = d.orgDisplay),
              (d.hidden = iN.isHidden(m.editorContainer))),
        ...
        function (r) {
          e.add(r.url, V, undefined, function () {
            ...
            (e = o),
              ...
              Vy(e, "IconsLoadError", qy("icons", t, n));
          });
        }
      );
    },
    CN = function (e, t) {
      ...
      (n = s),
        ...
        q(u)
          ? (hN(u) ||
              Uy.urls.hasOwnProperty(u) ||
              ((a = r.getParam("theme_url"))
                ? Uy.load(u, r.documentBaseURI.toAbsolute(a))
                : Uy.load(u, "themes/" + u + "/theme" + o + ".js")),
        ...
        ? t.getElement() &&
          ...
          (a = t.getElement().form || gN.getParent(e, "form")) &&
            ...
            t.getParam("hidden_input") &&
              !Dn(t.getElement()) &&
              (gN.insertAfter(
                gN.create("input", { type: "hidden", name: e }),
                e
              ),
              (t.hasHiddenInput = !0)),
    ...
    kN = function (o) {
      return function (r, e) {
        return U.from(e)
          ...
          .filter(Pt)
          .bind(function (e) {
            return EN(o, r, e.dom).or(
              ((t = o), (n = e.dom), U.from(bu.DOM.getStyle(n, t, !0)))
            );
            var t, n;
          })
          .getOr("");
      ...
      (FN.prototype.setupCommands = function (i) {
        ...
        this.addCommands({
          ...
          FontSize: function (e, t, n) {
            var r, o;
            (o = n),
              (r = i).formatter.toggle("fontsize", { value: DN(r, o) }),
              r.nodeChanged();
          },
  ...
  var UN = "data-mce-contenteditable",
    ...
    $N = function (t) {
      t.parser.addAttributeFilter("contenteditable", function (e) {
        qN(t) &&
          $(e, function (e) {
            e.attr(UN, e.attr("contenteditable")),
  ...
  var YN,
    ...
    ZN = function (e, t) {
      ...
      var n = bc(e);
      return n
        ? (e.eventRoot || (e.eventRoot = QN.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    eE = function (e, t, n) {
      var r, o, i, a, u;
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(ZN(n, e), e, n.delegates[e]),
    ...
    oE = function (e, t, n, r) {
      ...
      i.deactivate(),
        i.editorReadOnly !== a.editorReadOnly && VN(e, a.editorReadOnly),
        t.set(r),
        (o = r),
    ...
    lE =
        ...
        aE(uE(e.toLowerCase(), "+"), function (e) {
          e in cE
            ...
            : ((n.charCode = e.charCodeAt(0)),
              (n.keyCode = sE[e] || e.toUpperCase().charCodeAt(0)));
        });
        var r = [n.keyCode];
        for (t in cE) n[t] ? r.push(t) : (n[t] = !1);
        return (
          (n.id = r.join(",")),
          n.access && ((n.alt = !0), vt.mac ? (n.ctrl = !0) : (n.shift = !0)),
          n.meta && (vt.mac ? (n.meta = !0) : ((n.ctrl = !0), (n.meta = !1))),
          n
        );
      }),
      (fE.prototype.createShortcut = function (e, t, n, r) {
        ...
        return (
          (o[o.length - 1] = xt.extend(o[o.length - 1], {
            func: n,
            scope: r || this.editor,
          })),
          xt.extend(o[0], {
      ...
      : ((n = 0 === e.indexOf("//")),
        ...
        /^[\w\-]*:?\/\//.test(e) ||
          ((r = this.settings.base_uri
            ...
            : new yE(document.location.href).directory),
          (e =
  ...
  var bE = bu.DOM,
    ...
    NE =
      ...
      (EE.prototype.show = function () {
        this.hidden &&
          ...
          this.inline
            ...
            : (bE.show(this.getContainer()), bE.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      (EE.prototype.hide = function () {
        ...
        e.hidden ||
          ...
          e.inline
            ...
            : (bE.hide(e.getContainer()),
              bE.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      }),
      ...
      (EE.prototype.resetContent = function (e) {
        e === undefined
          ? ay(this, this.startContent, { format: "raw" })
          : ay(this, e),
      ...
      (EE.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = bE.get(this.id)), this.targetElm
        );
      }),
  ...
  function EE(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        (Su.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
        bu.DOM.styleSheetLoader._setReferrerPolicy(
          this.settings.referrer_policy
        )),
      ...
      this.settings.cache_suffix &&
        (vt.cacheSuffix = this.settings.cache_suffix.replace(/^[\?\&]+/, "")),
      (this.ui = {
        registry: dE(),
  ...
  var kE,
    ...
    IE = function (e) {
      e !== OE &&
        (e
          ? lu(window).on("resize scroll", LE)
          : lu(window).off("resize scroll", LE),
        (OE = e));
    },
    ME = function (t) {
      var e = PE;
      ...
      return (
        ...
        UE.activeEditor === t &&
          (UE.activeEditor = 0 < PE.length ? PE[0] : null),
    ...
    UE = xe(xe({}, JN), {
      ...
      setup: function () {
        ...
        (this.baseURL = new vE(n).toAbsolute(e)),
          ...
          (this.suffix = t),
          (r = this).on("AddEditor", E(um, r)),
          r.on("RemoveEditor", E(sm, r));
      },
              ...
              r.types
                ? TE(r.types, function (t) {
                    xt.each(o, function (e) {
                      return (
                        !_E.is(e, t.selector) || (n(c(e), AE({}, r, t), e), !1)
                      );
                    });
                  })
                : (xt.each(o, function (e) {
      ...
      add: function (e) {
        ...
        return (
          BE[e.id] === e ||
            (null === n.get(e.id) &&
              ("length" !== e.id && (BE[e.id] = e), BE.push(e), PE.push(e)),
            IE(!0),
            (n.activeEditor = e),
        ...
        if (e) {
          if (!q(e))
            return (
              ...
              w(r.get(n.id))
                ? null
                : (ME(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === PE.length &&
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new vE(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new vE(this.baseURL));
      },
    ...
    uk =
      ...
      (sk.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          void 0 === (e = rk.parse(e)) && (e = { error: "JSON Parse error." }),
            e.error
