tinymce.addI18n("ca", {
  ...
  "To open the popup, press Shift+Enter":
    "Per obrir la finestra emergent, premeu Maj.+Retorn",
  ...
  "Failed to load plugin url: {0}":
    "No s'ha pogut carregar l\u2019URL del complement: {0}",
  "Failed to initialize plugin: {0}":
    "No s'ha pogut inicialitzar el complement: {0}",
  example: "exemple",
  Search: "Cerca",
  All: "Tot",
  Currency: "Moneda",
  ...
  "yuan character, in hong kong and taiwan":
    "signe del iuan en Hong Kong i Taiwan",
  ...
  "Error: Form submit field collision.":
    "Error: error en el camp d\u2019enviament del formulari.",
  "Error: No form element found.":
    "Error: no s'ha trobat l'element del formulari.",
  Update: "Actualitzar",
  ...
  "Switch to or from fullscreen mode":
    "Canviar a o del mode de pantalla completa",
